...
const LinkItems: Array<LinkItemProps> = [
  ...
  { name: 'Job Offer', path: '/job-offers', entity: 'job_offer', service: AccessServiceEnum.PROJECT, icon: FiAward },
  {
    name: 'Job Opening',
    path: '/job-openings',
    entity: 'job_opening',
  ...
  { name: 'Onboarding', path: '/onboardings', entity: 'onboarding', service: AccessServiceEnum.PROJECT, icon: FiUsers },
