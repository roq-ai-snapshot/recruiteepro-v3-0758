...
function JobApplicationListPage() {
  ...
  const { data, error, isLoading, mutate } = useSWR<JobApplicationInterface[]>(
    ...
    () =>
      getJobApplications({
        relations: ['job_opening', 'user', 'interview.count', 'job_offer.count', 'onboarding.count'],
      }),
  );
            ...
            <Table variant="simple">
              <Thead>
                <Tr>
                  ...
                  {hasAccess('job_offer', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && <Th>job_offer</Th>}
                  {hasAccess('onboarding', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && <Th>onboarding</Th>}
